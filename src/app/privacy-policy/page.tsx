  ...
  const sections = [
    {
      ...
      paragraphs: [
        ...
        "We may share your information with other  Xyz Studio offices world-wide or with our partners. We may occasionally transfer or share your information with third parties who perform certain services on our behalf. However, such third parties have agreed to only use such information on behalf of  Xyz Studio. We reserve the right to disclose your Information with legal and regulatory bodies or pursuant to a judicial order for compliance.",
    ...
    },
    {
      title: "III. Security:",
      paragraphs: [
        "We use reasonable administrative, technical, and physical security measures to protect the information from unauthorized access, use, loss, or destruction. Information provided by you is stored on a secured web server managed by  Xyz Studio or an agent of  Xyz Studio performing services on our behalf.",
    ...
    },
    {
      ...
      paragraphs: [
        " Xyz Studio may provide links to other third-party websites and services. However,  Xyz Studio is not responsible for privacy statements, practices, or the contents of such third-party websites.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        " Xyz Studio shall not be responsible for the authenticity of the information you provide and therefore it is your duty to ensure that the information provided by you is authentic.",
      ],
    },
    {
      title: "VII. Children:",
    ...
    },
    {
      ...
      paragraphs: [
        "Any grievances or complaints, in relation to processing of information, should be addressed to  Xyz Studio in writing to the following contact email: email@xyz.studio. Grievances shall be redressed as expeditiously as possible.",
      ],
    },
    {
    ...
    <div className="p-6 py-14 lg:px-20 lg:py-20 flex flex-col gap-y-6 lg:gap-y-10 ">
      <div className="flex flex-col gap-y-3 lg:gap-y-4">
        ...
        <Description
          ...
          content="Xyz Studio is committed to respecting your privacy and choices while using our website. This policy applies to information collected by us on our website."
        />
      </div>
