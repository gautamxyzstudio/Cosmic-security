...
const TextInput: React.FC<ITextInputProps> = ({
  ...
  return (
    <div>
      <div className="w-full  pt-5 relative top-0 left-0    rounded-[4px] ">
        <h3
          ref={divRef}
          className=" pointer-events-none h-8 inline-block text-2xl text-white  absolute"
        >
          {placeHolder}
        </h3>
        <input
      ...
      <div className="h-[1px] mt-3 bg-background w-full " />
    </div>
  );
};
